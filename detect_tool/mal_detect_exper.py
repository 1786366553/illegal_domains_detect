...
def detect_malicious_exper():
    ...
    while True:
        ...
        if pro_tool_name == tool_name and pro_domain == domain and pro_result != '检测失败'.decode('utf8'):
            ...
            if tool_name in ['macfree', 'virustotal']:
                ...
                if dv is None or pro_result == '检测失败'.decode('utf8') or pro_tool_name != tool_name:
                    if tool_name=='baidu':
